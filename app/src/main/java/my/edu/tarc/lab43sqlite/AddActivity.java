...
public class AddActivity extends AppCompatActivity {
    ...
    public void saveRecord(View v){
        ...
        if(phone.isEmpty()){
            editTextPhone.setError(getString(R.string.error_phone)); //setError display error message
            return;
        }
        ...
        if(email.isEmpty()){
            ...
            return;
        }else if(!android.util.Patterns.EMAIL_ADDRESS.matcher(email).matches()){ //check for input match with email pattern
